...
func (h *handler) GetOrderByIDForCustomer(ctx *gin.Context) {
	...
	utils.RenderSuccess(ctx, http.StatusOK, "customer", "order fetched successfully", map[string]interface{}{
		"data": order,
	})
}

func (h *handler) GetOrderByCustomerIDForCustomer(ctx *gin.Context) {
